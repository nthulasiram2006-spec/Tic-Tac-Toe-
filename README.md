...
- 🎮 **Game Board** – 3×3 grid of clickable boxes
- 🏆 **Winner Message** – Displays the winner when a player wins
...
- ♻️ "Reset Game" button to reset at any time
- 🚫 Buttons auto-disable after being clicked
...
- 🎨 **Colors** – Modify background colors in `style.css` (e.g., `#548687`, `#ffffc7`, `#b0413e`)
- 🔤 **Fonts** – Change font size or family in `style.css`
- 🧩 **Board Size** – Adjust `.Box` dimensions using `vmin` values
...
- 🔊 Add sound effects on clicks and wins
